...
public class RemarkCommandTest {
    ...
    public void execute_addRemarkUnfilteredList_success() {
        ...
        Person editedPerson = new PersonBuilder(firstPerson).withRemark(REMARK_STUB)
                .build();
        ...
        assertCommandSuccess(remarkCommand,
                model,
                expectedMessage,
                expectedModel);
    }
    ...
    public void execute_deleteRemarkUnfilteredList_success() {
        Person firstPerson = model.getFilteredPersonList()
                .get(INDEX_FIRST_PERSON.getZeroBased());
        Person editedPerson = new PersonBuilder(firstPerson).withRemark("")
                .build();

        RemarkCommand remarkCommand = new RemarkCommand(INDEX_FIRST_PERSON,
                new Remark(editedPerson.getRemark()
                        .toString()));
    ...
    public void execute_invalidPersonIndexUnfilteredList_failure() {
        ...
        assertCommandFailure(remarkCommand,
                model,
    ...
    public void equals() {
        ...
        RemarkCommand commandWithSameValues = new RemarkCommand(INDEX_FIRST_PERSON,
                new Remark(VALID_REMARK_AMY));
        assertEquals(commandWithSameValues,
                standardCommand);

        // same object -> returns true
        assertEquals(standardCommand,
                standardCommand);
        ...
        assertNotEquals(new ClearCommand(),
                standardCommand);
